...
// It is not distributed with Node; you have to install it separately.
    ...
    request.onload = function()
    {
        ...
        // Returns an new array of country objects whose currency code is USD 
        const getCountryObjectsBasedOnCurrency = data.filter((item) => {
        ...
        const getCountryNames = getCountryObjectsBasedOnCurrency.map((item)=>{
            return item.name
        })
